...
pixi global install r-bayesrel
```
...
It is possible to list all of the versions of `r-bayesrel` available on your platform:
...
```
pixi search r-bayesrel --channel conda-forge
```
